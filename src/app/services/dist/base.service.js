...
var BaseService = /** @class */ (function () {
    ...
    BaseService.prototype.iniciarIndexedDb = function () {
    ...
    BaseService.prototype.salvarAPI = function (seguro) {
        this.http.post(this.API_SEGUROS + "/api/seguros", seguro).subscribe(function () { return alert("sucesso"); }, function (err) { return console.log(err); });
    };
    BaseService.prototype.salvarLocal = function (seguro) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.table.add(seguro)];
                    case 1:
                        _a.sent();
    ...
    BaseService.prototype.enviarIndexedDbParaAPI = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    BaseService.prototype.cadastrar = function (seguro) {
    ...
    BaseService.prototype.listar = function () {
        return this.http.get(this.API_SEGUROS + "/api/seguros");
    };
    BaseService.prototype.ouvirStatusConexao = function () {
        var _this = this;
